                            ...
                            setTimeout(async function() {
                                ...
                                if (error > 0) {
                                    ...
                                    init.driver.findElement(By.id('NFe')).then(() => {
                                        ...
                                        var html_date = await init.driver.executeScript("return document.getElementsByClassName('wID50')[1].innerText;");
                                        var arr_date = misc.searchDateInStrings(html_date);
